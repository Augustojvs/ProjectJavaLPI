...
public class FrmCliente extends javax.swing.JFrame {
    ...
    public FrmCliente() {
        initComponents();
        conexao.Conectar();
        preencherTabela("SELECT * FROM cliente ORDER BY codigocliente");
       // try{
          //  conexao.rs.first();
           // do{
             //   txtComboEstado.addItem(conexao.rs.getString("estado"));
       ...
       // } catch (SQLException ex){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro no MaskFormatter do endereco!\nERRO:" + ex);
        }
        try{
            MaskFormatter form = new MaskFormatter("##.###-###");
            txtCep.setFormatterFactory(new DefaultFormatterFactory(form));
            
        } catch (ParseException ex){
            JOptionPane.showMessageDialog(null, "Erro no MaskFormatter do cep!\nERRO:" + ex);
        }
    }
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        try {
            PreparedStatement pst = conexao.conn.prepareStatement("INSERT INTO cliente (nome, endereco, cidade, estado, cep, telefone) VALUES (?, ?, ?, ?, ?, ?)");

            pst.setString(1, txtNome.getText());
            pst.setString(2, txtEndereco.getText());
            pst.setString(3, txtCidade.getText());
            pst.setString(4, txtComboEstado.getSelectedItem().toString());
    ...
    private void btAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarActionPerformed
        try{
            ...
            PreparedStatement pst = conexao.conn.prepareStatement("UPDATE cliente SET nome = ?, endereco = ?, cidade = ?, estado = ?, cep = ?, telefone = ? WHERE codigocliente = ?");
            pst.setString(1, txtNome.getText());
            pst.setString(2, txtEndereco.getText());
            pst.setString(3, txtCidade.getText());
            pst.setString(4, txtComboEstado.getSelectedItem().toString());
        ...
        if(txtCodigo.isEnabled() == false){
            ...
            if(txtCodigo.getText().equalsIgnoreCase("") == false){
                try{
                    ...
                    PreparedStatement pst = conexao.conn.prepareStatement("DELETE FROM cliente WHERE codigocliente = ?");
    ...
    private void btPrimeiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPrimeiroActionPerformed
        ...
        try {
            ...
            conexao.rs.first();
            txtCodigo.setText(conexao.rs.getString("codigocliente"));
            ...
            txtCep.setText(conexao.rs.getString("cep"));
    ...
    private void txtTabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtTabelaMouseClicked
     String codigocliente = "" + txtTabela.getValueAt(txtTabela.getSelectedRow(), 0);
        conexao.Conectar();
        
        conexao.executaSQL("SELECT * FROM cliente WHERE codigocliente = '" + codigocliente + "'");
        try {
            conexao.rs.first();
            txtCodigo.setText(conexao.rs.getString("codigocliente"));
            txtNome.setText(conexao.rs.getString("nome"));
    ...
    public void preencherTabela(String SQL){
        ...
        String [] Colunas = new String[]{"Codigo", "Nome", "Endereço", "Cidade", "Estado", "Cep", "Telefone"};
        
        conexao.executaSQL(SQL);
        try {
            conexao.rs.first();
            do{
            dados.add(new Object[]{conexao.rs.getInt("codigocliente"), conexao.rs.getString("nome"), conexao.rs.getString("endereco"), conexao.rs.getString("cidade"), conexao.rs.getString("estado"),conexao.rs.getString("cep"),conexao.rs.getString("telefone")});
        }while(conexao.rs.next());
        ...
        txtTabela.getColumnModel().getColumn(1).setPreferredWidth(80);
        ...
        txtTabela.getColumnModel().getColumn(3).setPreferredWidth(110);
        txtTabela.getColumnModel().getColumn(3).setResizable(false);
        txtTabela.getColumnModel().getColumn(4).setPreferredWidth(50);
        ...
        txtTabela.getColumnModel().getColumn(6).setPreferredWidth(95);
